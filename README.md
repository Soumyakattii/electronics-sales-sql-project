...
- *Salespersons* – Sales team details  
...
- Performed checks like row counts and duplicate detection  
- Wrote SQL queries at different levels for analysis  
...
- Connect SQL data with Power BI for visualization
